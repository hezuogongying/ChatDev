...
def get_config(company):
    ...
    TODO： 
    1、这里可以作为客户在PHP交互输入入口，参数来自交互界面保存到mongodb中，日志也是
    2、可以宝塔面板构建多个项目，多个类型团队-公司。  任务分时排队执行
    3、团队间可构成产业链，结果数据再送入到复合公司
    4、微信生态提供现实接口。微信群、接单界面、微信支付、发票
    5、物流由美团等接单团队实现
    6、需求由赶集网招聘信息、各需求网站、私域团购、实体商城公众号
    7、替换人员：旅游、消费积分兑换、公益、道德建设积分兑换代金券
    """
